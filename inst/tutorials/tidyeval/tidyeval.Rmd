...
The function above works like we expect, but it does not yet "look-and-feel" more like dplyr. For example, we would like to use a bare symbol, rather than a string to identify the variable.
...
Go over again symbols, expressions, and quosures.
